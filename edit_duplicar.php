                    ...
                    <div class="col-md-12">
                        <form method="post" action="edit_duplicar.php?id=<?php echo $id ?>&id_curso=<?php echo $id_curso?>&id_docente=<?php echo $id_docente?>" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div><button type="submit" name="duplicar" class="btn btn-primary">Cargar Capítulos y  Bibliografía</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                        </form>
                    </div>
                </div>
            </div>

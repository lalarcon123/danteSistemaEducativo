      ...
      <div class="container-fluid">
        ...
        <!--<div class="row">-->
              <form action="edit_user_password.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
                  ...
                  <div class="col-lg-4 col-6">
                    <!-- <div class="form-group">-->
                            <button type="submit" name="update-pass" class="btn btn-primary pull-left">Cambiar</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form>
                    <!--</div>-->
                  </div>
            </form>
        <!--</div>-->

        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_curso_estudiantil.php");
                    include("modal/new_curso_estudiantil.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Curso Estudiantil</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detallecursoestudiantil" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Descripcion</th>
...
<script>
    ...
    var detalletitulo = function(){
           var table =$("#Dt_detallecursoestudiantil").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoCursoEstudiantil.php",
        ...
        obtener_data_editar("#Dt_detallecursoestudiantil tbody",table);
    }

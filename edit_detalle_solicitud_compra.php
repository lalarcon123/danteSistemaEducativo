                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_detalle_solicitud_compra.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>&id_proveedor=<?php echo $id_proveedor ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="add" class="btn btn-primary">Agregar Producto</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">

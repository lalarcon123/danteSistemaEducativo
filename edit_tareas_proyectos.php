                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_tareas_proyectos.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="tarea_diaria" class="btn btn-primary">Cargar Tarea</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <?php

        ...
        var detallecapitulocontenido = function(){
            ...
            var table =$("#Dt_detallecontenido").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"duracion"},
                    {"data":"status"},                    
                    {"defaultContent":"<button type='button'  class='eliminar btn btn-xs btn-primary' onclick='eliminar_material();'><i class='fa fa-pencil-square-o'></i><span class='glyphicon glyphicon-remove'></span></button>"}
                ],

                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="edit_evaluacion_preguntas.php?id=<?php echo $id ?>&id_curso=<?php echo $id_curso ?>" enctype="multipart/form-data">
                                ...
                                <div><button type="submit" name="evaluacion_preguntas" class="btn btn-primary">Cargar Pregunta</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                                <div class="x_content">
        ...
        var detallepreguntas = function(){
            ...
            var table =$("#Dt_detallepreguntas").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"pregunta"},
                    {"data":"estado"},                    
                    {"defaultContent":"<button type='button'  class='respuestas btn btn-lg btn-link' onclick='ingresar_respuestas();' title='Respuestas'><span class='glyphicon glyphicon-pencil'></span></button><button type='button'  class='activar btn btn-lg btn-link' onclick='activar_preguntas();' title='Activar'><span class='glyphicon glyphicon-ok'></span></button><button type='button'  class='eliminar btn btn-lg btn-link' onclick='eliminar_preguntas();' title='Inactivar'><span class='glyphicon glyphicon-trash'></span></button>"}
                ],

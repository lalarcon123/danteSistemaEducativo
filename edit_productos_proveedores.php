                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_productos_proveedores.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="proveedor_productos" class="btn btn-primary">Cargar Proveedor</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">

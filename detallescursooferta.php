    ...
    var detallecursooferta = function(){
           var table =$("#Dt_detallecurso").DataTable({
               ...
               "columns":[
                   ...
                   {"data":"fecha_fin"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='agrega btn btn-link btn-lg' onclick='agrega_capitulo();' title='Capítulos'><span class='glyphicon glyphicon-file'></span></button><button type='button' class='material btn btn-link btn-lg' onclick='agrega_material();' title='Bibliografía'><span class='glyphicon glyphicon-book'></span></button><button type='button' class='actividades btn btn-link btn-lg' onclick='agrega_actividades();' title='Actividades'><span class='glyphicon glyphicon-check'></span></button><button type='button' class='evaluacioncontenido btn btn-link btn-lg' onclick='evaluacion_contenido();' title='Evaluación'><span class='glyphicon glyphicon-hourglass'></span></button><button type='button' class='finalizar btn btn-link btn-lg' onclick='finalizar_cruso();' title='Finalizar'><span class='glyphicon glyphicon-pushpin'></span></button>"}
               ],

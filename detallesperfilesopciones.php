    ...
    var detalleperfil = function(){
           var table =$("#Dt_detalleperfiles").DataTable({
               ...
               "columns":[
                   ...
                   {"data":"group_name"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='editar btn btn-link btn-lg' onclick='obtener_data_editar();' title='Editar'><span class='glyphicon glyphicon-edit'></span></button>"}
               ],

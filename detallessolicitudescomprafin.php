    ...
    var detalleuser = function(){
           var table =$("#Dt_detallesolicitudcompra").DataTable({
               ...
               "columns":[
                   ...
                   {"data":"observacion"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='detalle btn btn-primary btn-xs' onclick='agrega_detalle();' title='Detalle solicitud'><i class='fa fa-pencil-square-o'></i><span class='glyphicon glyphicon-list'></span></button>"}
               ],

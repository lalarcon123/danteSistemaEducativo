...
if(isset($_POST['add'])) {
            ...
            if(empty($errors)) {
                ...
                $query  = "insert into paralelo (descripcion) values (";
                $query .=" '{$descripcion}'";
                $query .=")";

                $result   = $db->query($query);
                if($result && $db->affected_rows() === 1){
                    $session->msg('s',"Paralelo ingresado exitosamente. ");
                } else {
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-add">
                    <i class="fa fa-plus-circle"></i> Agregar Paralelo  <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Agregar Paralelo</h4>
                </div>

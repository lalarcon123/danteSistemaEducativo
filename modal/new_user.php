     ...
     //$session->msg('d','<b>Error!</b> El usuario que intenta crear ya se encuentra registrado en el sistema.');
           ...
           if(empty($errors)){
                ...
                if($db->query($query)){
                  ...
                  $from = "Administrador@ACADEMICODANTE.COM.EC";
                  $to =   $mail;
...
<script>
    ...
    <div> <!-- Modal -->
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-add"><i class="fa fa-plus-circle"></i> Agregar Usuario <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
            </div>
        </div>

    ...
    var detallecurso = function(){
           var table =$("#Dt_detallecurso").DataTable({
               ...
               "columns":[
                   ...
                   //{"data":"objetivo"},
                   {"data":"duracion"},
                   {"defaultContent":"<button type='button'  class='descargar btn btn-lg btn-link' onclick='descargar_archivo();' title='Descargar'><span class='glyphicon glyphicon-picture'></span></button>"},
                   {"data":"fecha_registro"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='editar btn btn-link btn-lg' onclick='obtener_data_editar();' title='Editar' data-toggle='modal' data-target='.bs-example-modal-lg-udp'><span class='glyphicon glyphicon-edit'></span></button>"}
               ],

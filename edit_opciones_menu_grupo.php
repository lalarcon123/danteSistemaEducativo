                ...
                <div class="">
                    <div class="">
                        <form method="post" action="edit_opciones_menu_grupo.php?id=<?php echo $id ?> enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="detalle" class="btn btn-primary">Cargar Detalle</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">
        ...
        var detalle = function(){
            ...
            var table =$("#Dt_detalleopciones").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"observacion"},
                    {"data":"estado"},
                    {"defaultContent":"<button type='button'  class='activar btn btn-lg btn-link' onclick='activar();' title='Aprobar'><span class='glyphicon glyphicon-ok'></span></button><button type='button'  class='inactivar btn btn-lg btn-link' onclick='inactivar();' title='Rechazar'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></button>"}
                ],

                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_producto_imagenes.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="imagenxproducto" class="btn btn-primary">Cargar Imagen</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">

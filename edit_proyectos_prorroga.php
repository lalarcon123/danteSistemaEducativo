                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_proyectos_prorroga.php?id=<?php echo $id ?>&nombre=<?php echo $nombre ?>" enctype="multipart/form-data">
                            ...
                            <div><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <?php
    ...
    <script>
        ...
        var descargar_archivo = function(tbody,table) {
            $(tbody).on("click","button.descargar",function() {
                ...
                var myWindow = window.open(archivo, "Sistema Académico Dante", "width=500,height=500");
            });
        }

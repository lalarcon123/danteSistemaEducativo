        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_paralelo.php");
                    include("modal/new_paralelo.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Paralelo</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detalleparalelo" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Descripcion</th>
...
<script>
    ...
    var detalletitulo = function(){
           var table =$("#Dt_detalleparalelo").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoParalelo.php",
        ...
        obtener_data_editar("#Dt_detalleparalelo tbody",table);
    }

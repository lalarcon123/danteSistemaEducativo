...
<script>
    ...
    var detalledocente = function(){
           ...
           var table    =$("#Dt_detalleestudiantes").DataTable({
               ...
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoEstudiantes.php?id="+id_user,
        ...
        obtener_data_editar("#Dt_detalleestudiantes tbody",table);
        reseteo_password("#Dt_detalleestudiantes tbody",table);
        agregar_titulo("#Dt_detalleestudiantes tbody",table);
    }

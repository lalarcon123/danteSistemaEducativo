...
<body>
    <div> <!-- Modal -->
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-add" id="nuevaEvaluacion"><i class="fa fa-plus-circle"></i> Agregar Evaluación <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
            </div>
            <div class="pull-left">
                <form class="form-horizontal form-label-left input_mask" method="post" action="regresar" id="regresar" name="regresar">
                    <input name="regresar" type="submit" class="btn btn-primary" value="Regresar"></input>
                </form>
            </div>
        </div>
    </div>

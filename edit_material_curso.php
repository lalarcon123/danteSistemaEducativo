                    ...
                    <div class="col-md-12">
                        <form method="post" action="edit_material_curso.php?id=<?php echo $id ?>&id_docente=<?php echo $id_docente ?>" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div><button type="submit" name="agregar_imagenes" class="btn btn-primary">Cargar Bibliografía</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">
        ...
        var detallematerial = function(){
            ...
            var table =$("#Dt_detallematerial").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"enlace"},
                    {"data":"estado"},
                    {"defaultContent":"<button type='button'  class='descargar btn btn-lg btn-link' onclick='descargar_archivo();' title='Descargar'><span class='glyphicon glyphicon-cloud-download'></span></button><button type='button'  class='activar btn btn-lg btn-link' onclick='activar_material();' title='Activar'><span class='glyphicon glyphicon-ok'></span></span></button><button type='button'  class='eliminar btn btn-lg btn-link' onclick='eliminar_material();' title='Inactivar'><span class='glyphicon glyphicon-trash'></span></button>"}
                ],

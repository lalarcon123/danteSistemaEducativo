            ...
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                           <table id="Dt_detallerepresentantes" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Nombre</th>
...
<script>
    ...
    var detalledocente = function(){
           ...
           var table    =$("#Dt_detallerepresentantes").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoRepresentantes.php?id="+id_user,
               ...
               "columns":[
                   ...
                   {"data":"mail"},
                   {"data":"status"},
                   {"defaultContent":"<button type='button' class='editar btn btn-link btn-lg' onclick='obtener_data_editar();' data-toggle='modal' data-target='.bs-example-modal-lg-udp' title='Editar'><span class='glyphicon glyphicon-edit'></span></button><button type='button' class='reseteo btn btn-link btn-lg' onclick='reseteo_password();' data-toggle='modal' data-target='.bs-example-modal-lg-udp1' title='Reseteo Password'> <span class='glyphicon glyphicon-user'></span></button><button type='button' class='agregar btn btn-link btn-lg' onclick='agregar_estudiante();' title='Estudiantes'><span class='glyphicon glyphicon-option-horizontal'></span></button>"}
               ],
               "language": idioma_espanol
           });
        obtener_data_editar("#Dt_detallerepresentantes tbody",table);
        reseteo_password("#Dt_detallerepresentantes tbody",table);
        agregar_estudiante("#Dt_detallerepresentantes tbody",table);
    }
    ...
    var agregar_estudiante = function(tbody,table) {
        $(tbody).on("click", "button.agregar", function () {
            var data = table.row($(this).parents("tr")).data();
            var id   = data.id;
            window.location.href="edit_asig_estudiantes.php?id="+id;
        });
    }
    var idioma_espanol = {

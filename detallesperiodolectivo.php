        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_periodo_lectivo.php");
                    include("modal/new_periodo_lectivo.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Período Lectivo</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detalleperiodolectivo" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Inicio</th>
...
<script>
    ...
    var detalletitulo = function(){
           var table =$("#Dt_detalleperiodolectivo").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoPeriodoLectivo.php",
               ...
               "columns":[
                   ...
                   {"data":"fin"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='editar btn btn-link btn-lg' onclick='obtener_data_editar();' data-toggle='modal' data-target='.bs-example-modal-lg-udp'><span class='glyphicon glyphicon-edit'></span></button>"}
               ],
               "language": idioma_espanol
           });
        obtener_data_editar("#Dt_detalleperiodolectivo tbody",table);
    }
    var obtener_data_editar = function(tbody,table) {
    $(tbody).on("click", "button.editar", function () {
        var data = table.row($(this).parents("tr")).data();
        var id      = $("#id").val(data.id),
            inicio  = $("#inicio").val(data.inicio),
            fin     = $("#fin").val(data.fin),

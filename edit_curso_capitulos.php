        ...
        var detallecapitulo = function(){
            ...
            var table =$("#Dt_detallecapitulo").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"duracion"},
                    {"data":"estado"},                    
                    {"defaultContent":"<button type='button'  class='contenido btn btn-lg btn-link' onclick='ingresar_contenido();' title='Contenido'><span class='glyphicon glyphicon-inbox'></span></button><button type='button'  class='activar btn btn-lg btn-link' onclick='activar_capitulo();' title='Activar'><span class='glyphicon glyphicon-ok'></span></button><button type='button'  class='eliminar btn btn-lg btn-link' onclick='eliminar_capitulo();' title='Inactivar'><span class='glyphicon glyphicon-trash'></span></button>"}
                ],

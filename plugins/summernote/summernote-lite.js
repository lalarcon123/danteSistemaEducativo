          ...
          children: [
              ...
              dropdown({
                  items: [
                      ...
                      '  <div class="btn-sm">',
                      '    <input type="color" id="html5bcp" class="note-btn btn-primary" value="#21104A" style="width:100%;" data-value="cp">',
                      ...
                      '  <div class="btn-sm">',
                      '    <input type="color" id="html5fcp" class="note-btn btn-primary" value="#21104A" style="width:100%;" data-value="cp">',

                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="edit_capitulos_contenido.php?id=<?php echo $id ?>&id_curso=<?php echo $id_curso ?>" enctype="multipart/form-data">
                                ...
                                <div><button type="submit" name="capitulo_contenido" class="btn btn-primary">Cargar Contenido</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                                <div class="x_content">
        ...
        var detallecontenido = function(){
            ...
            var table =$("#Dt_detallecontenido").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"duracion"},
                    {"data":"status"},                    
                    {"defaultContent":"<button type='button'  class='descargar btn btn-lg btn-link' onclick='descargar_archivo();' title='Visualizar'><span class='glyphicon glyphicon-cloud-download'></span></button><button type='button'  class='activar btn btn-lg btn-link' onclick='activar_contenido();' title='Activar'><span class='glyphicon glyphicon-ok'></span></button><button type='button'  class='eliminar btn btn-lg btn-link' onclick='eliminar_contenido();' title='Inactivar'><span class='glyphicon glyphicon-trash'></span></button>"}
                ],

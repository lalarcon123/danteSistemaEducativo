                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="edit_evaluacion_respuestas.php?id=<?php echo $id ?>&id_curso=<?php echo $id_curso ?>&id_evaluacion=<?php echo $id_evaluacion ?>" enctype="multipart/form-data">
                                ...
                                <div><button type="submit" name="evaluacion_respuestas" class="btn btn-primary">Cargar Respuesta</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                                <div class="x_content">
        ...
        var detallerespuestas = function(){
            ...
            var table =$("#Dt_detallerespuestas").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"valida"},
                    {"data":"estado"},                    
                    {"defaultContent":"<button type='button'  class='activar btn btn-lg btn-link' onclick='activar_respuestas();' title='Activar'><span class='glyphicon glyphicon-ok'></span></button><button type='button'  class='eliminar btn btn-lg btn-link' onclick='eliminar_respuestas();' title='Inactivar'><span class='glyphicon glyphicon-trash'></span></button>"}
                ],

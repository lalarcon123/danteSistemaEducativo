    ...
    var detallecurso = function(){
           var table =$("#Dt_detallecurso").DataTable({
               ...
               "columns":[
                   ...
                   {"data":"fecha_registro"},
                   {"data":"fecha_pago"},
                   {"defaultContent":"<button type='button' class='editar btn btn-link btn-lg' onclick='obtener_data_editar();' data-toggle='modal' data-target='.bs-example-modal-lg-udp'>Pago  <i class='fa fa-pencil-square-o'></i><span class='glyphicon glyphicon-shopping-cart'></span></button>"}
               ],

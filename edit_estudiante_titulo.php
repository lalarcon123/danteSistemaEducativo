                    ...
                    <div class="col-md-12">
                        <form method="post" action="edit_estudiante_titulo.php?id=<?php echo $id ?>" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div><button type="submit" name="agregar_imagenes" class="btn btn-primary">Cargar Título</button><!--<form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form>-->
        ...
        var detalleservicio = function(){
            ...
            var table =$("#Dt_detalletitulos").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"status"},
                    {"defaultContent":"<button type='button'  class='eliminar btn btn-xs btn-primary' onclick='eliminar_titulo();'><i class='fa fa-pencil-square-o'></i>Eliminar <span class='glyphicon glyphicon-remove'></span></button>"}
                ],

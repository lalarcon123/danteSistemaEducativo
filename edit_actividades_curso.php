                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_actividades_curso.php?id=<?php echo $id ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="actividades_curso" class="btn btn-primary">Cargar Actividades</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-primary">Regresar</button></form></div>
                            <div class="x_content">
